...
myApp.controller('mainCtrl', function Main($scope, $http){
    ...
    $http.get('https://artist-search-wldxkdncmi.now.sh/popular').success(function(data) {
      $scope.users = data.results;
      $scope.colors = ["cyan","orange","purple","blue","pink","red","lime","purple"];
    }).error(function(data, status) {
      alert('get data error!');
    });
   
  });
  myApp.controller('mainCtrl1', function Main($scope, $http){
  
    $http.get('https://artist-search-wldxkdncmi.now.sh/nowplaying').success(function(data) {
      $scope.users = data.results;
      $scope.colors = ["cyan","orange","purple","blue","pink","red","lime","purple"];
    }).error(function(data, status) {
      alert('get data error!');
  ...
  myApp.controller('mainCtrl2', function Main($scope, $http){
  
    $http.get('https://artist-search-wldxkdncmi.now.sh/toprated').success(function(data) {
      $scope.users = data.results;
      $scope.colors = ["cyan","orange","purple","blue","pink","red","lime","purple"];
    }).error(function(data, status) {
      alert('get data error!');
  ...
  myApp.controller('mainCtrl3', function Main($scope, $http){
  
    $http.get('https://artist-search-wldxkdncmi.now.sh/upcoming').success(function(data) {
      $scope.users = data.results;
      $scope.colors = ["cyan","orange","purple","blue","pink","red","lime","purple"];
    }).error(function(data, status) {
      alert('get data error!');
